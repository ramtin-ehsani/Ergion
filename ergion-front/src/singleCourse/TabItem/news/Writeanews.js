...
const Write = (props) => {
  ...
  const sendnewshandler = (event) => {
    Axios.post(
      "http://127.0.0.1:8000/api/course/news/",
        ...
        <div className="post-page-main" style={{display:'flex'}}>
          <Card className={classes.root} dir="rtl">
            <CardHeader
              ...
              avatar={
                <Avatar
                  src={props.course.instructor_profile_picture}
                  aria-label="recipe"
              ...
              subheader={
                <Typography className="date" component="h6"></Typography>
              }
            />
                    ...
                    <Grid container item>
                      ...
                      {isimage >= 1 ? (
                        <Grid item direction="column">
                          <iconButton id="id1" onClick={image1delete}>
                      ...
                      {isimage >= 2 ? (
                        <Grid item direction="column">
                          <iconButton id="id2" onClick={image2delete}>
                            <HighlightOffIcon style={{ color: "red" }} />
                          </iconButton>
                          <img
                      ...
                      {isimage >= 3 ? (
                        <Grid item direction="column">
                          <iconButton id="id3" onClick={image3delete}>
                            <HighlightOffIcon style={{ color: "red" }} />
                          </iconButton>
                          <img
                      ...
                      {isimage >= 4 ? (
                        <Grid item direction="column">
                          <iconButton id="id4" onClick={image4delete}>
                            <HighlightOffIcon style={{ color: "red" }} />
                          </iconButton>
                          <img
                      ...
                      {isvideo ? (
                        <Grid item>
                          {" "}
                          <iconButton id="vd1" onClick={videodelete}>
                            <HighlightOffIcon style={{ color: "red" }} />{" "}
                          </iconButton>{" "}
