            ...
            >
              <ValidatorForm form="form" onSubmit={this.addEpisodeButton}>
                <DialogTitle
                  id="error-dialog"
                  dir="rtl"
                  className={classes.newEpisodeTitle}
                >
                  ایجاد یک جلسه جدید
                </DialogTitle>
            ...
            >
              ...
              <DialogContent>
                <DialogContentText dir="rtl" style={{ padding: "10px" }}>
                  آیا میخواهید این{" "}
                  {this.state.isChapterToDelete ? "سرفصل" : "جلسه"} را حذف کنید؟
                </DialogContentText>
              </DialogContent>
            ...
            {this.state.list.length > 0 ? (
                        ...
                        >
                          ...
                          <ListItemText>
                            {!item.isTextMode ? (
                                ...
                                {this.state.isOwner &&
                                  ...
                                  !item.isTextMode && (
                                    <Fade in={item.buttonShown} timeout={400}>
                                      <Button
                                        onClick={(e) =>
                                          this.chapterEditButton(e, index)
                                        }
                              ...
                              <ValidatorForm
                                onSubmit={() =>
                                  this.chapterEditButtonSaveChanges(index)
                                }
                              >
                                <InputBase
                                  fullWidth
                              ...
                              <Fade in={item.buttonShown} timeout={400}>
                                <div>
                                  <Button
                                    ...
                                    aria-haspopup="true"
                                    onClick={(e) =>
                                      this.menuHandleClick(e, index, true)
                                    }
                                    className={classes.veticalDots}
                                  ...
                                  <StyledMenu
                                    ...
                                    onClose={(e) =>
                                      this.menuHandleClick(e, index, false)
                                    }
                                  >
                                    <StyledMenuItem
                                      onClick={(e) =>
                                        this.chapterOrEpisodeRemoveButton(
                                          e,
                                          index,
                                          0,
                                          true
                      ...
                      {item.episodes.length > 0 ? (
                              ...
                              <Grid container spacing={1} dir="rtl">
                                  ...
                                  >
                                    ...
                                    {!episode.isNameTextModeON ? (
                                      ...
                                      >
                                        ...
                                        >
                                          {this.state.isOwner &&
                                            episode.isNameButtonShown &&
                                            !episode.isNameTextModeON && (
                                              <Fade
                                                in={episode.isNameButtonShown}
                                                timeout={400}
                                                style={{ alignSelf: "center" }}
                                              >
                                                <Button
                                                  onClick={(e) =>
                                                    this.episodePropagationEditButton(
                                                      e,
                                                      index,
                                                      indx,
                                                      true
                                      ...
                                      <ValidatorForm
                                        onSubmit={() =>
                                          this.episodeEditButtonSaveChanges(
                                            index,
                                            indx,
                                            true
                                          )
                                ...
                                >
                                  <Tabs
                                    ...
                                    onChange={(e, v) =>
                                      this.handleTabChange(v, index, indx)
                                    }
                                  >
                                    <Tab
                                      label="توضیحات"
                        ...
                        <div>
                          {!this.state.isOwner && (
                            ...
                            >
                              <Typography>
                                <Box fontSize={18}>جلسه ای وجود ندارد</Box>
                              </Typography>
                            </div>
                          )}
                        </div>
              ...
              <div>
                {!this.state.loading && !this.state.isOwner && (
                  ...
                  >
                    <Typography>
                      <Box fontSize={18}>سرفصلی وجود ندارد</Box>
                    </Typography>
                  </div>
                )}
              </div>
                      ...
                      <InputAdornment position="end">
                        ...
                        >
                          {this.state.isButtonShown && (
                            <AddBoxIcon
                              className={classes.newChapterButtonStyle}
                            />
                          )}
                        </IconButton>
                      </InputAdornment>
