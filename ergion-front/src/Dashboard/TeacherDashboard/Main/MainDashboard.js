...
class MainDashboard extends Component {
    ...
    loadMore(page){
        ...
        axios.get(`https://api.classinium.ir/api/teacher/timeline/?page=${page}`,config)
        .then((res)=>{
            ...
            axios.get('https://api.classinium.ir/api/teacher/profile-details/',config)
            .then((res)=>{
            ...
            if(page === 1){
                axios.get('https://api.classinium.ir/api/teacher/join-requests/',config)
                .then((res)=>{
                    let requests=[]
                    res.data.map((req)=>{
                        requests.push(req)
    ...
    rejectHandler=(id)=>{
        ...
        axios.post('https://api.classinium.ir/api/teacher/join-requests/',{
            accept:0,
            id: item[0].id
        },config).then((res)=>{
            console.log(res)
