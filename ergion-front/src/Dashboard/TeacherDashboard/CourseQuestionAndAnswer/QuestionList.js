...
class QuestionList extends Component {
  ...
  answerDelete = () => {
    axios
      .delete(
        "http://130.185.78.113:8000/api/forum/episode-answer/?answer_id=" +
  ...
  submitAnswer = () => {
    axios
      .post(
        "http://130.185.78.113:8000/api/forum/episode-answer/",
        {
  ...
  componentDidMount() {
    ...
    axios
      .get(
        "http://130.185.78.113:8000/api/forum/episode-answer/?course_id=" + courseId,
        this.config
      )
      .then((resp) => {
