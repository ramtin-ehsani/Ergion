...
function CourseLayout(props) {
  ...
  React.useEffect(() => {
    // setTimeout(() => {
    const promise1 = axios.get("http://130.185.78.113:8000/api/student/courses/", {
      headers: {
          ...
          >
            ...
            <Grid item>
              <Button
                ...
                color="primary"
                onClick={() => {
                  history.push("/student_dashboard/find-your-course");
                }}
              >
                  ...
                  <CardActions className={classes.cardActions}>
                    <ButtonGroup dir="ltr" fullWidth>
                      ...
                      <Button
                        ...
                        color="primary"
                        className="toSee"
                        href={`/student_dashboard/added_courses/${list.id}`}
                      >
                        مشاهده
                      </Button>
                    </ButtonGroup>
