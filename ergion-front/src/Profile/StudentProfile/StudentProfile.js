...
class Profile extends Component {
  ...
  getValues = () => {
    axios.get('http://130.185.78.113:8000/api/student/profile/', this.config)
      .then((response) => {
        // handle success
  ...
  onFileChange = event => {
    ...
    if (event.target.files && event.target.files[0]) {
      ...
      axios.put('http://130.185.78.113:8000/api/student/profile/',
        data, this.config)
        .then(() => {
  ...
  deletePicture = () => {
    ...
    axios.put('http://130.185.78.113:8000/api/student/profile/', {profile_picture:null},
